...
class CosmosDb():
    ...
    def get(self, id: str, container: str, partition_key: str) -> Optional[Dict[str, Any]]:
        try:
            return self.get_container(container).read_item(item=id, partition_key=partition_key or id)
