...
class AppSettings(BaseSettings):
    ...
    COSMOS_DB_CONTAINER_SERVICES: str = "services"
    COSMOS_DB_CONTAINER_STEPS: str = "steps"
    COSMOS_DB_CONTAINER_PIPELINES: str = "pipelines"
    COSMOS_DB_CONTAINER_BATCH_EXECUTIONS: str = "batch_executions"
    COSMOS_DB_CONTAINER_ACTIVITIES: str = "activities"
    COSMOS_DB_CONTAINER_STEP_OUTPUTS: str = "step_outputs"
