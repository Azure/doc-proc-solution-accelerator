...
class BlobQueueClient(AzureClient):
    ...
    def __init__(self, settings : Dict = {}):
        ...
        self.storage_account_name = settings.get("STORAGE_ACCOUNT_NAME", config.get_value("STORAGE_ACCOUNT_NAME"))
        self.queue_name = settings.get("QUEUE_NAME", config.get_value("QUEUE_NAME", 'docproc-execution-requests'))
